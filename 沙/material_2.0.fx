...
#define ALBEDO_MAP_FILE "TexturesCom_DesertSand3_2x2_1K_albedo.png"

const float3 albedo = 1.0;
const float2 albedoMapLoopNum = 5.5;
...
const float normalMapLoopNum = 5.5;
...
const float smoothnessMapLoopNum = 5.5;
...
const float occlusionMapLoopNum = 5.5;
...
const float parallaxMapLoopNum = 5.5;
