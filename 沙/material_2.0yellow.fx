...
#define ALBEDO_MAP_FILE "TexturesCom_DesertSand3_2x2_1K_albedo(yellow1).png"

const float3 albedo = 1.0;
const float2 albedoMapLoopNum = 1.1;
...
#define NORMAL_MAP_FILE "TexturesCom_DesertSand3_2x2_1K_normal.png"

const float normalMapScale = 1.0;
const float normalMapLoopNum = 1.1;
...
#define SMOOTHNESS_MAP_FILE "TexturesCom_DesertSand3_2x2_1K_smoothness.png"

const float smoothness = 1.0;
const float smoothnessMapLoopNum = 1.1;

#define METALNESS_MAP_FROM 0
#define METALNESS_MAP_UV_FLIP 0
#define METALNESS_MAP_SWIZZLE 0
#define METALNESS_MAP_APPLY_SCALE 0
#define METALNESS_MAP_FILE "TexturesCom_DesertSand3_2x2_1K_metallic.png"
...
#define OCCLUSION_MAP_FILE "TexturesCom_DesertSand3_2x2_1K_ao.png"

const float occlusion = 1.0;
const float occlusionMapLoopNum = 1.1;

#define PARALLAX_MAP_FROM 1
#define PARALLAX_MAP_TYPE 0
#define PARALLAX_MAP_UV_FLIP 0
#define PARALLAX_MAP_SWIZZLE 0
#define PARALLAX_MAP_FILE "TexturesCom_DesertSand3_2x2_1K_height.png"

const float parallaxMapScale = 0.4;
const float parallaxMapLoopNum = 1.1;
