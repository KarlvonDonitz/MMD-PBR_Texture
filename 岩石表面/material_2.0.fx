...
#define ALBEDO_MAP_FILE "TexturesCom_Rock_CliffGranite3_1K_albedo.png"

const float3 albedo = 1.0;
const float2 albedoMapLoopNum = 0.5;

#define ALBEDO_SUB_ENABLE 0
#define ALBEDO_SUB_MAP_FROM 0
#define ALBEDO_SUB_MAP_UV_FLIP 0
#define ALBEDO_SUB_MAP_APPLY_SCALE 0
#define ALBEDO_SUB_MAP_FILE "E:\\.jpg"
...
#define NORMAL_MAP_FILE "TexturesCom_Rock_CliffGranite3_1K_normal.png"

const float normalMapScale = 1.0;
const float normalMapLoopNum = 0.5;

#define NORMAL_SUB_MAP_FROM 0
#define NORMAL_SUB_MAP_TYPE 0
#define NORMAL_SUB_MAP_UV_FLIP 0
#define NORMAL_SUB_MAP_FILE "Sniper_Nor_01.tga"
...
#define SMOOTHNESS_MAP_FILE "TexturesCom_Rock_CliffGranite3_1K_smoothness.png"

const float smoothness = 1.0;
const float smoothnessMapLoopNum = 0.5;

#define METALNESS_MAP_FROM 0
#define METALNESS_MAP_UV_FLIP 0
#define METALNESS_MAP_SWIZZLE 0
#define METALNESS_MAP_APPLY_SCALE 0
#define METALNESS_MAP_FILE "TexturesCom_Rock_CliffGranite3_1K_metallic.png"

const float metalness = 0.0;
const float metalnessMapLoopNum = 0.5;
...
#define OCCLUSION_MAP_FILE "TexturesCom_Rock_CliffGranite3_1K_ao.png"

const float occlusion = 1.0;
const float occlusionMapLoopNum = 0.5;

#define PARALLAX_MAP_FROM 1
#define PARALLAX_MAP_TYPE 0
#define PARALLAX_MAP_UV_FLIP 0
#define PARALLAX_MAP_SWIZZLE 0
#define PARALLAX_MAP_FILE "TexturesCom_Rock_CliffGranite3_1K_height.png"

const float parallaxMapScale = 0.4;
const float parallaxMapLoopNum = 0.5;
...
#define EMISSIVE_MAP_FILE "Sniper_Emss.tga"
